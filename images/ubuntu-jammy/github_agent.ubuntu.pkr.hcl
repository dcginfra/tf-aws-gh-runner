...
build {
  ...
  provisioner "shell" {
    ...
    inline = concat([
      ...
      "sudo apt-get -y update",
      "sudo apt-get -y install automake autotools-dev bsdmainutils build-essential clang cmake containerd.io docker-ce docker-ce-cli gcc git jq libssl-dev libtool libzmq3-dev nodejs openssh-client pkg-config python3 unzip",
